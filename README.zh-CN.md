...
- 📝 **实时预览**：编辑器内可切换预览模式，支持 Markdown/Mermaid/KaTeX 数学公式实时渲染
- 🖼️ **图片资产管理**：本地图片上传到同级 `assets/<文档名>/`，正文插入相对路径
...
- **插入工具**：链接、图片 URL/本地图片上传、Mermaid 思维导图/流程图模板
...
本项目内置 Markdown 编辑器吸收并改造了 [lengyi-markdown-editor](https://github.com/woyin2024/lengyi-markdown-editor) 的编辑器能力，包括工具栏写作操作、实时预览流程、编辑效率工具以及导出相关交互。
